import{d,o as l,c as h,u as t,k as p,f as g,a as e,e as s,H as a,M as i,g as o,t as b,z as _}from"./index-CboZIT6v.js";import{j as r,a as c}from"./agent-BFtiMqbc.js";import{R as v}from"./RobotIcon-BQcGCiSa.js";import"./lm-BizhkHiD.js";import"./index-BZxdWYOY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const f={class:"fixed bottom-12 right-8 z-50"},j=d({__name:"AgentJoe",setup(m){return(u,n)=>(l(),h("div",f,[t(r).isVisible?(l(),p(v,{key:0,class:"text-5xl cursor-pointer"})):g("",!0)]))}}),x=_('<div class="prosed"><h1>Basic Agent</h1><p>The body of Agent Smith can interact with the user. Note: we use Vuejs and Tailwindcss for the UI code examples. </p><p><span class="text-bold">Note:</span> the interactivity bindings are managed with <a href="https://github.com/nanostores/nanostores">Nanostores</a>. Install the <a href="https://github.com/nanostores/nanostores?tab=readme-ov-file#integration">integration</a> for your framework, here we will use <a href="https://github.com/nanostores/vue">@nanostores/vue</a> for the examples below. </p></div>',1),S={class:"flex flex-col space-y-5 mt-5"},k=e("p",null,[o("Let's create a basic agent named Joe in a "),e("kbd",null,"agent/agent.ts"),o(" file:")],-1),w=e("div",null,[o("The "),e("kbd",null,"joeState"),o(" variable will be used to manage the UI interactivity. Now give let's our agent a body in a "),e("kbd",null,"agent/AgentJoe.vue"),o(" file. In the script part:")],-1),V=e("div",null,"In the template part:",-1),y=e("div",{class:"prose"},[e("h2",null,"Interactions"),e("h3",null,"Show / hide")],-1),N={class:"mt-3"},I=e("div",{class:"pt-5"},[e("a",{href:"javascript:openLink('/the_body/interactions/talk')"},"Next: the talk interaction")],-1),J=`import { useAgentSmith } from "@agent-smith/body";
