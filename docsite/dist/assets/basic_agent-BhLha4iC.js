import{d as c,o as l,c as g,f as s,s as r,m as h,i as p,v as b,a as t,h as o,g as n,H as i,M as a,k as d,t as v}from"./index-56o_VcVb.js";import{R as f}from"./RobotIcon-Diw22Hhd.js";const x={class:"fixed bottom-12 right-8 z-50"},k=c({__name:"AgentWidget",setup(u){return(m,e)=>(l(),g("div",x,[s(r).isVisible?(l(),h(f,{key:0,class:"text-5xl cursor-pointer"})):p("",!0)]))}}),w={class:"flex flex-col space-y-5 mt-5"},V={class:"mt-3"},j=`import { useAgentSmith } from "@agent-smith/body";
