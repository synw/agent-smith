...
</div>`,Q=w({__name:"memory",setup(y){const a=$[0],e=x(a.tasks.task1.state),m=R({params:{},data:{},isCompleted:!1});async function T(){await a.start();const d={param_task1:"task 1 param value"};await a.runTask("task1",d)}async function k(){const d=await a.tmem.tasks.get("task1");m.params=d.params,m.data=d.data,m.isCompleted=d.isCompleted}async function c(){await a.tmem.tasks.set("task1",{params:{},data:{},isCompleted:!1}),await k()}return C(()=>a.syncMem()),(d,s)=>(J(),M("div",null,[s[13]||(s[13]=t("div",{class:"prosed"},[t("h1",null,"Memory")],-1)),t("div",H,[s[7]||(s[7]=t("div",null,"The jobs can use a transient memory module to keep track of the tasks results in the Indexeddb database in the browser. Install the module: ",-1)),t("div",null,[p(o(g),{hljs:o(f),code:L,lang:"html"},null,8,["hljs"])]),s[8]||(s[8]=t("div",null,"To enable the memory for a job declare it like this:",-1)),t("div",null,[p(o(g),{hljs:o(f),code:W,lang:"ts"},null,8,["hljs"])]),s[9]||(s[9]=t("div",null,[r("With the memory enabled the input "),t("kbd",null,"params"),r(" of a task and it's output "),t("kbd",null,"data"),r(" will be automatically saved after each task run. Let's create code to run the task 1 with some parameters, and then read the result from memory. ")],-1)),t("div",null,[p(o(g),{hljs:o(f),code:F,lang:"ts"},null,8,["hljs"])]),s[10]||(s[10]=t("div",null,[r("Note: the job "),t("kbd",null,"init"),r(" has been replaced by "),t("kbd",null,"syncMem"),r(": this automatically synchronize the ephemeral state to the memory. In other words the data from previous task runs will be available in the state ")],-1)),t("div",V,[t("button",{class:"btn light",onClick:s[0]||(s[0]=h=>T()),disabled:o(e).isRunning},"Execute",8,q),t("button",{class:"btn light",onClick:s[1]||(s[1]=h=>k())},"Read memory"),t("button",{class:"btn light",onClick:s[2]||(s[2]=h=>c()),disabled:!o(e).isCompleted},"Reset task1 memory",8,z)]),t("div",D,[t("div",null,[s[3]||(s[3]=r("Task 1 is running: ",-1)),t("code",null,v(o(e).isRunning),1)]),t("div",null,[s[4]||(s[4]=r("Task 1 is completed: ",-1)),t("code",null,v(o(e).isCompleted),1)]),t("div",null,[s[5]||(s[5]=r("Task 1 params: ",-1)),t("code",null,v(m.params),1)]),t("div",null,[s[6]||(s[6]=r("Task 1 data: ",-1)),t("code",null,v(m.data),1)])]),s[11]||(s[11]=t("div",null,"Execute the job, read the memory and then reload the page and read the memory again: the task 1 data will still be there after the first execution. ",-1)),t("div",null,[p(o(g),{hljs:o(f),code:G,lang:"html"},null,8,["hljs"])]),s[12]||(s[12]=t("div",null,"This way the data of a previous task can be used as input for a given task. And the tasks can be rerun after a reload. This make it possible to create long running jobs and run only some tasks in it. ",-1))])]))}});export{Q as default};
