import{d as p,y as w,r as T,e as y,o as n,c as o,a as t,g as d,f as e,H as c,M as f,h as i,t as k,F as S,A as C,i as R}from"./index-56o_VcVb.js";import{u as _,t as A}from"./task1-DLOr-Jmq.js";import{t as B,a as J}from"./task4-DCU_ahSf.js";const M=[A,B,J],N=[_({name:"demo_job",title:"A demo job",tasks:M})],E={class:"flex flex-col space-y-5 mt-5"},I={class:"flex flex-col space-y-1"},O={class:"flex flex-col space-y-3"},V={class:"flex-row flex w-full items-center"},$={class:"text-2xl mr-2"},F={key:0,class:"warning w-2 h-2"},H={key:1,class:"success w-2 h-2"},L={key:2,class:"semilight w-2 h-2"},P={class:"flex-grow"},U={class:"flex flex-row space-x-3"},W={class:"flex flex-row space-x-2"},D=["disabled"],q=`import { Ref, onBeforeMount } from "vue";
