import{d as c,b as p,o as u,c as d,a as t,e,u as s,H as o,M as a,t as h}from"./index-BhJnANCl.js";import{e as r}from"./agent4-DWtgKCTi.js";const m=t("div",{class:"prosed"},[t("h1",null,"History management")],-1),_={class:"flex flex-col space-y-5 mt-5"},f=t("div",null,"The history of a conversation can be handled in templates. Let's create an expert with an Alpaca template:",-1),x=t("div",null,"Let's add some history turns:",-1),y={class:"txt-light"},v=t("div",{class:"prose"},[t("h2",null,"Usage")],-1),H=t("div",null,"To record the history turns use this:",-1),g=t("div",{class:"pt-5"},[t("a",{href:"javascript:openLink('/the_brain/templates/few_shots')"},"Next: few shots")],-1),T=`import { useLmExpert } from "@agent-smith/brain";
