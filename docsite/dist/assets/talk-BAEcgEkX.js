import{d as b,j as p,s as r,c,o as d,h as g,f as o,F as f,g as n,n as v,k as i,e as k,a as t,i as l,H as s,M as a}from"./index-BPJ47-82.js";import{R as x}from"./RobotIcon-CDX6bw_T.js";const y={class:"fixed bottom-12 right-8 flex flex-row items-end z-50"},w=["innerHTML"],j=b({__name:"AgentV2",setup(h){const m=p(()=>{let e="txt-lighter";return r.value.isInteracting&&(e="txt-light"),e});return(e,u)=>(d(),c("div",y,[o(r).isVisible?(d(),c(f,{key:0},[o(r).isInteracting===!0?(d(),c("div",{key:0,class:"bubble bubble-bottom-left mr-5 txt-light",innerHTML:o(r).text},null,8,w)):g("",!0),n(x,{class:v(["text-5xl cursor-pointer",m.value]),onClick:u[0]||(u[0]=z=>o(i).toggleInteract())},null,8,["class"])],64)):g("",!0)]))}}),I={class:"flex flex-col space-y-5 mt-5"},M=`.bubble {
    z-index: 20;
    position: relative;
    max-width: 30em;
