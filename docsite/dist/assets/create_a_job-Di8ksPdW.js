import{d as c,o as g,c as p,a as s,h as e,e as l,u as n,H as i,M as r}from"./index-BMtjbDYc.js";import{a as f,u as j,t as v}from"./task1-DXJslRWZ.js";let b=0,m=k=>null;async function w(){return await new Promise(a=>{m=a;let o=1;b=setInterval(()=>{console.log(o,"- running task 2"),++o},1e3)}),{ok:!0}}async function T(){console.log("Aborting task 2"),clearInterval(b),m(!1)}const A=f({id:"task2",title:"Demo task 2",run:w,abort:T}),x=[v,A],h=[j({name:"demo_job",title:"A demo job",tasks:x})],y={class:"flex flex-col space-y-5 mt-5"},I={class:"flex flex-row space-x-3"},C=`import { useAgentTask } from "@agent-smith/jobs";
