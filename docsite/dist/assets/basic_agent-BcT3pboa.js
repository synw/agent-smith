...
</div>`,E=d({__name:"basic_agent",setup(m){return(u,n)=>(l(),h("div",null,[x,e("div",S,[w,s(t(a),{hljs:t(i),code:J,lang:"ts"},null,8,["hljs"]),k,e("div",null,[s(t(a),{hljs:t(i),code:A,lang:"ts"},null,8,["hljs"])]),V,e("div",null,[s(t(a),{hljs:t(i),code:T,lang:"html"},null,8,["hljs"])]),y,e("div",null,[e("button",{class:"btn light",onClick:n[0]||(n[0]=R=>{t(r).isVisible?t(c).hide():t(c).show()})},"Toggle Joe"),e("div",N,[o("Joe is visible: "),e("code",null,b(t(r).isVisible),1)])]),e("div",null,[s(t(a),{hljs:t(i),code:B,lang:"html"},null,8,["hljs"])])]),s(j),I]))}});export{E as default};
