import{d as n,b as i,o as l,c as h,a as t,e as c,u as s,H as d,M as u,t as p}from"./index-C1UhW6KS.js";import{e as a}from"./agent4-CTJCYkGO.js";const m=t("div",{class:"prosed"},[t("h1",null,"Few shots prompts")],-1),_={class:"flex flex-col space-y-5 mt-5"},f=t("div",null,"Adding a few shots to the prompt often helps to improve the quality of the output. It works the same as history, except that shots come first. ",-1),v=t("div",null,"Let's create a few shot prompt (using the Alpaca template):",-1),g=t("div",null,"The template rendering:",-1),w={class:"txt-light"},y=`import { TurnBlock } from "modprompt";
